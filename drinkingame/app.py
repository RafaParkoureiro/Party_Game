...
def get_question():
    ...
    if spiciness < 15:
        ...
        medium_prob = min((spiciness - 15) * 0.05, 0.5)  # Increases by 5% per question, max 50%
        hard_prob = min((spiciness - 25) * 0.05, 0.5)  # Starts increasing after spiciness 25, max 50%
